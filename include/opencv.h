    ...
    if (transpose) {
        if(channels == 1) {
            ...
            for(int ii=0; ii<channels; ++ii) {
                input_(ii, af::span, af::span) = af::moddims(input(af::span, af::span, ii),
                                                          1, input.dims(1), input.dims(0));
            }
        }
        ...
        if(channels == 1) {
            ...
            for(int ii=0; ii<channels; ++ii) {
                input_(ii, af::span, af::span) = af::moddims(input(af::span, af::span, ii).T(),
                                                              1, input.dims(0), input.dims(1));
            }
        }
